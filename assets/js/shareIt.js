    ...
    $.fn.shareIt = function( options ) {
        ...
        this.each(function(){
            ...
            var con = "<div class='mct_shareit_container mct_shareit' id=mct_shareit_container_"+settings.rand+">"+
                    ...
                    "<div class='mct_facebook_like mct_margin_top' id=mct_facebook_like_"+settings.rand+"><a href='https://www.facebook.com/"+settings.facebook.pageId+"' class='mct_shareit_button fb' data-service='facebook_like'><span class='mct_shareit_button_title'>Like</span><div class=mct_shareit_button_count><i>0</i></div></a></div>"+
